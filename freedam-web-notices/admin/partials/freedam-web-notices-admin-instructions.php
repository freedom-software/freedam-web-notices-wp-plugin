...
<img loading="lazy" alt="Demonstration of how to active the plugin" style="border: 1px solid hsl(210deg 14% 89%);" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/activate.png'; ?>" height="148" width="994"/>
<br><br>
<p>Once activated go to the setting - FreeDAM Web Notices Section</p>
<img loading="lazy" alt="Demonstration of where to find the plugin settings" style="border: 1px solid hsl(210deg 14% 89%);" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/settings.png'; ?>" height="351" width="159"/>
<hr>
...
<img loading="lazy" alt="Demonstration of how to generate notices" style="border: 1px solid hsl(210deg 14% 89%);" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/freedam-our-website2.png'; ?>" height="319" width="500"/>
...
<img loading="lazy" alt="Demonstration of how to add plugin output to a page" style="border: 1px solid hsl(210deg 14% 89%);" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/addtopage.png'; ?>" height="242" width="500"/>
<p>Inside the shortcode block enter [freedam-web-notices] and update the page.</p>
<img loading="lazy" alt="Demonstration of the plugin shortcode" style="border: 1px solid hsl(210deg 14% 89%);" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/shortcodeblock.png'; ?>" height="182" width="500"/>
<hr>
...
<img loading="lazy" alt="Demonstration of how to customize a page" style="border: 1px solid hsl(210deg 14% 89%);" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/customise.png'; ?>" height="185" width="638"/>
<p>Choose 'Additional CSS from the menu.</p>
<img loading="lazy" alt="Demonstration of how to add CSS to the theme" style="border: 1px solid hsl(210deg 14% 89%);" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/additionalcss.png'; ?>" height="187" width="296"/>
<p>Target the elements you wish and create the appropriate CSS.</p>
<img loading="lazy" alt="Demonstration of what custom CSS for a web-notice may look like" style="border: 1px solid hsl(210deg 14% 89%);" src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) . 'assets/additionalcss2.png'; ?>" height="311" width="290"/>
